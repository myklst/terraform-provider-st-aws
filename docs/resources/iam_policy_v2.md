...
~> **NOTE:** The usage of this resource conflicts with the `st-aws_permission_set_attachment` resource and will permanently show a difference if both are defined.
